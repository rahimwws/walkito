...
export const ONBOARDING_RU = {
  ...
  // Родительный падеж после «от»; в теле — именительный. Одна подставляемая
  // величина не может быть и тем и другим, поэтому имя вписано в предложение.
  'onboarding.note.body1':
    'Привет, я Рахим. Я сделал Walkito, потому что мои собственные стопы были той проблемой, на которую я так и не получил внятного ответа.',
  'onboarding.note.body2':
    'Исследований хватало. Не хватало того, что превращает их во что-то достаточно небольшое, чтобы делать это в обычный вторник.',
  'onboarding.note.body3':
    'Вот это оно и есть: несколько минут в день, в том порядке, который подтверждён исследованиями. Спасибо, что решили попробовать.',

  // ── The note at the end of onboarding ────────────────────────────────────
  // Черновик — см. комментарий в en/onboarding.ts.
  'onboarding.note.title': 'Пара слов от нас',
  'onboarding.note.body1':
    'Привет, мы Рахим и Рахман. Мы сделали Walkito, потому что наши собственные стопы были той проблемой, на которую нам так и не дали внятного ответа.',
  'onboarding.note.body2':
    'Исследований хватало, а вот чего-то достаточно небольшого, чтобы делать это в обычный вторник, не было. Вот это оно и есть: несколько минут в день, в том порядке, который подтверждён исследованиями.',
  'onboarding.note.signature': 'Рахим и Рахман',
  'onboarding.note.cta': 'Оценить Walkito',
  'onboarding.note.later': 'Может быть позже',
};
